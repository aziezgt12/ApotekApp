            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <?php } ?>
                  ...
                  <li><a href="data_obat.php"><i class="fa fa-suitcase"></i> Data Obat <span class=""></span></a></li>
                  <li><a href="suplier.php"><i class="fa fa-user"></i> Data Suplier <span class=""></span></a></li>
