<?php include 'page/top.php' ?>
       ...
       <?php $a = $_GET['kode'];
              $sql = mysql_query("SELECT * FROM Kategori WHERE kode='$a'")
        ?>
        ...
        <form action="#" class="form-horizontal form-label-left" method="post" >
          ...
          <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name"> Kode Kategori <span class="required"></span></label>
            ...
            <input type="text" id="first-name" name="kode_kategori" required="required" class="form-control col-md-7 col-xs-12" readonly value="0000<?php echo $data['kode']; ?>" >
                        </div></div>
