                    ...
                    <table id="" class="table table-bordered">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
        <a href="e-sat.php?kode=<?php echo $data['kode'] ?>"  class="btn btn-danger btn-sm"><span class="glyphicon glyphicon-edit"></span></a>
        <a name="hapus" onClick="if(confirm('Apakah anda yakin ingin menghapus data ini ??')){ location.href='sat.php?kode=<?php echo $data['kode']; ?>' }"  class="btn btn-success btn-sm"><span class="glyphicon glyphicon-trash"  ></span></a>
                          </td>
